...
description_short: Mimecast es una de las plataformas de seguridad de email empresarial más reconocidas del mundo. Fundada en 2003, protege contra phishing, malware, BEC, ransomware y data loss con filtrado avanzado, sandboxing, archivado, continuity y awareness training integrados. Usada por más de 40.000 organizaciones globalmente, incluyendo gran parte del Fortune 1000, finanzas y gobierno. Desde USD 4-8 por usuario por mes.
logo_url: /uploads/ciberseguridad/2026/04/idfm-khl1e-logos-0a624f85.jpg
rating: 4.4
price_from: 4
price_currency: USD
pricing_model: monthly
featured: false
meta_title: "Mimecast Email Security: Protección Empresarial Completa - Análisis 2026"
meta_description: Mimecast es una de las plataformas líderes de email security empresarial con 40.000+ clientes. Análisis completo de protección, archive, continuity, awareness training, precios y posicionamiento frente a Proofpoint, Abnormal y Microsoft Defender.
updated: 2026-04-24
features:
...
**Typosquatting detection**: dominios con typos comunes del corporativo
**Homoglif detection**: dominios con caracteres visualmente idénticos pero diferentes (Unicode spoofing)
**SSL cert monitoring**: alerta cuando se emiten certificados para dominios similares
**Takedown service**: Mimecast puede gestionar takedowns legales de dominios maliciosos
...
**Precio**: USD 4-5 por usuario por mes
**Incluye**:
...
**Precio**: USD 6-8 por usuario por mes
**Incluye todo del Starter más**:
...
**Precio**: USD 9-12 por usuario por mes
**Incluye todo del Standard más**:
